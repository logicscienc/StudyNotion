...
import CTAButtom from '../HomePage/Button'
...
const LearningGridArray = [
    ...
    },
    {
        ...
        description: "Studynotion partners with more than 275+ leading and companies to bring"
    },
    {
        order: 4,
                        ...
                        ? (
                            <div className='lg:w-[90%] flex flex-col pb-5 gap-3'>
                                ...
                                <div className='w-fit mt-4'>
                                    <CTAButtom active={true} linkto={card.BtnLink}>
                                       {card.BtnText} 
